                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <h5>Post title Romanian <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <input type="text" name="post_title_ro" class="form-control" required="" value="{{ $blogpost->post_title_ro }}">
                                                    @error('post_title_ro')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea id="editor2" name="post_details_ro" rows="10" cols="80">
                                                    {!! $blogpost->post_details_ro !!}
						</textarea>
                                                </div>
                                            </div>
