                        ...
                        <div class="table-responsive">
                            ...
                            <form method="post" action="{{ route('subcategory.update') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="subcategory_name_ro" class="form-control" value="{{ $subcategory->subcategory_name_ro }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="subcategory_discount" class="form-control" value="{{ $subcategory->subcategory_discount }}">
