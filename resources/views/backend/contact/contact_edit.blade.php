                        ...
                        <div class="table-responsive">
                            ...
                            <form method="post" action="{{ route('contact.update',$contact->id) }}">
                               ...
                               <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="email" class="form-control" required value="{{ $contact->email }}">
                                        @error('email')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea type="text" name="address" class="form-control" required rows="3" >{{ $contact->address }}</textarea>
                                        @error('address')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
