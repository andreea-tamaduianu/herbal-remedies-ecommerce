                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_tags_ro" class="form-control" data-role="tagsinput" value="{{ $products->product_tags_ro }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_type_en" class="form-control" data-role="tagsinput" value="{{ $products->product_type_en }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_type_ro" class="form-control" data-role="tagsinput" value="{{ $products->product_type_ro }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_benefit_en" class="form-control" data-role="tagsinput" value="{{ $products->product_benefit_en }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_benefit_ro" class="form-control" data-role="tagsinput" value="{{ $products->product_benefit_ro }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_mode_of_use_en" class="form-control" data-role="tagsinput" value="{{ $products->mode_of_use_en }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_mode_of_use_ro" class="form-control" data-role="tagsinput" value="{{ $products->mode_of_use_ro }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_destinated_to_en" class="form-control" value="{{ $products->destinated_to_en }}" data-role="tagsinput">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_destinated_to_ro" class="form-control" value="{{ $products->destinated_to_ro }}" data-role="tagsinput">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_weight" class="form-control" required="" value="{{ $products->product_weight }}">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_quantity" class="form-control" required="" value="{{ $products->product_qty }}">
		...
		{!! $products->short_description_en !!}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="short_description_ro" id="textarea" class="form-control" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <fieldset>
                                                        <input type="checkbox" id="checkbox_4" name="new_arrival" value="1" {{ $products->new_arrival == 1 ? 'checked': '' }}>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_meta_title" class="form-control" required="" value="{{ $products->product_meta_title }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_meta_keywords" class="form-control" required="" value="{{ $products->product_meta_keywords }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="product_meta_description" id="textarea" class="form-control" required>{!! $products->product_meta_description !!}</textarea>
                                                </div>
                                            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box bt-3 border-info">
                    ...
                    <form method="post" action="{{ route('product.update.multi.image') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row row-sm">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <a href="{{ route('product.delete.multi.image',$img->id) }}" class="btn btn-sm btn-danger" id="delete" title="Delete Data"><i class="fa fa-trash"></i> </a>
                                        </h5>
                                        <p class="card-text">
                                        <div class="form-group">
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box bt-3 border-info">
                    <div class="box-header">
                        <h4 class="box-title">Product video <strong>update</strong></h4>
                    </div>


                    <form method="post" action="{{ route('product.update.video') }}" enctype="multipart/form-data">
                        @csrf

                        <input type="hidden" name="id" value="{{ $products->id }}">
                        <input type="hidden" name="old_video" value="{{ $products->product_video }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                        <div class="form-group">
                                            <label class="form-control-label">Change video <span class="tx-danger">*</span></label>
