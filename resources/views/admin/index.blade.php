...
@php
$date = date('d');
$today = App\Models\Order::whereDay('created_at',$date)->sum('amount');
$month = date('F');
        ...
        <div class="row">
                ...
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">
                        <div class="icon bg-primary-light rounded w-60 h-60">
                            <i class="text-primary mr-0 font-size-24 mdi mdi-cash-usd"></i>
                        </div>
                        <div>
                ...
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">
                        <div class="icon bg-danger-light rounded w-60 h-60">
                            <i class="text-danger mr-0 font-size-24 mdi mdi-clipboard-alert"></i>
                        </div>
                        <div>
            ...
            <div class="col-12">
                <div class="box">
                    ...
                    @php
                    $orders = App\Models\Order::orderBy('id','DESC')->limit(6)->get();
                    @endphp
                            ...
                            <table class="table no-border">
                                <thead>
                                    ...
                                    <tr class="text-uppercase bg-lightest">
                                        ...
                                        <th style="min-width: 100px"><span class="text-fade">Invoice no.</span></th>
