                ...
                <div class="col-md-6">
                    ...
                    <div class="checkout-progress-sidebar ">
                        <div class="panel-group">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="unicase-checkout-title">Type in your card information</h4>
                                </div>
                                ...
                                <form action="{{route('stripe.order')}}" method="post" id="payment-form">
                                    ...
                                    <div class="form-row">
                                        <label for="card-element">
                                            ...
                                            @if(Session::has('coupon'))
                                            <input type="hidden" name="coupon_name" value="{{ $data['coupon_name'] }}">
...
<script type="text/javascript">
    ...
    var stripe = Stripe('pk_test_51IZwp0LUKJlGErzwEJbPX0FfCPymmX8RZJspOzGEVrw3o2vPvDEieBTaY05pCt0NeLfhhWwnQOMSbqVrVfHqKy9P008VI0XYsW');
